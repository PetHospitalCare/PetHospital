            ...
            <div className="min-h-screen flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm">
                    <div className="text-center">
                        <h1 className="text-3xl font-bold text-green-500">Successfully!</h1>
                        ...
                        <p className="font-semibold text-lg mb-10">Now you can log in to your account </p>


                        <StepProgressBar step={4} />
                        <Link to="/login" className="text-blue-500 underline">Confirm & Login</Link>
                    </div>
                </div>
            </div>
        </div>
