                            ...
                            <div
                                ...
                                <div className="flex flex-col flex-1">
                                    ...
                                    <div className="mt-auto flex items-center gap-3">
                                        ...
                                        <button
                                            className="flex items-center justify-center w-6 h-6 bg-slate-400 rounded-full hover:bg-slate-500">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-white"
                                                 viewBox="0 0 124 124">
                                                <path
                                                    d="M112 50H12C5.4 50 0 55.4 0 62s5.4 12 12 12h100c6.6 0 12-5.4 12-12s-5.4-12-12-12z"></path>
                                            </svg>
                                        </button>
                                        ...
                                        <button
                                            className="flex items-center justify-center w-6 h-6 bg-slate-800 rounded-full hover:bg-slate-900"
                                            onClick={() => addToCardFunction(item)}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-3 fill-white"
                                                 viewBox="0 0 42 42">
                                                <path
                                                    d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z"></path>
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="ml-auto flex flex-col">
                                    <button
                                        className="w-6 h-6 flex items-center justify-center bg-red-500 rounded-full hover:bg-red-600">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-white"
                                             viewBox="0 0 24 24">
                                            <path
                                                d="M19 7a1 1 0 0 0-1 1v11.191A1.92 1.92 0 0 1 15.99 21H8.01A1.92 1.92 0 0 1 6 19.191V8a1 1 0 0 0-2 0v11.191A3.918 3.918 0 0 0 8.01 23h7.98A3.918 3.918 0 0 0 20 19.191V8a1 1 0 0 0-1-1Zm1-3h-4V2a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v2H4a1 1 0 0 0 0 2h16a1 1 0 0 0 0-2ZM10 4V3h4v1Z"></path>
                                        </svg>
                                    </button>
