            ...
            <div className="ml-4 mr-4 px-4 py-8">
                ...
                <div className="grid grid-cols-12 gap-6">
                    ...
                    <div className="col-span-2 flex flex-col">
                        <div className="bg-yellow-50 p-4 rounded-lg flex-grow">
                            <img
                                src="/thucung001.jpg"
                    ...
                    <div className="col-span-7 flex flex-col">
                        {/* Breadcrumb outside the white border container */}
                        ...
                        <div className="bg-white border rounded-lg p-6 flex-grow flex flex-col">
                    ...
                    <div className="col-span-3 flex flex-col">
                        <div className="bg-white border rounded-lg p-6 flex-grow">
                            <h2 className="text-xl font-semibold mb-4">Hoá đơn</h2>
