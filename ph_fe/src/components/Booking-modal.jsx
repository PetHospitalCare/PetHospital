                        ...
                        {user && user?.role?.includes("customer") ? (
                                                ...
                                                >
                                                    <div className="flex items-center">
                                                        ...
                                                        <span className="ml-3 block truncate font-normal group-data-selected:font-semibold">
                                                            {pet?.name ? pet?.name : "Vui lòng chọn thú cưng"}
                                                        </span>
                                                    </div>
                                                </ListboxOption>
                                            ))}
                            ...
                            <div className="flex gap-4 justify-center">
                                {["dog", "cat"].map((pet) => (
                                    <button
                                        key={pet}
                                        className={`border-2 rounded-lg p-2 w-32 text-center transition-all ${formData?.type === pet ? "border-blue-500 shadow-lg" : "border-gray-300"}`}
                                        onClick={() => setFormData({ ...formData, type: pet, pet_id: "" })}
                                    >
